...
export default [
    {
        ...
        paragraph_one: "At British AUC's Free Application Centre, our highly qualified and experienced counsellors are dedicated to guiding you towards the right academic path and helping you make informed decisions about your future career.",
        paragraph_two: "We understand that budget constraints can be a factor in studying abroad, and we strive to assist you in finding affordable universities that align with your financial resources.",
        image: image1,
    },
    {
        id: 2,
    ...
    },
    {
        ...
        paragraph_one: "At British AUC's Free Application Centre, we are committed to helping Nigerian students secure scholarships, whether they are need-based or athletic scholarships. We have established partnerships with institutions that offer generous scholarships, discounts, or bursaries. ",
    ...
    },
    {
        ...
        paragraph_one: "British AUC's Free Application Centre regularly hosts officials from renowned universities and colleges at our application centers. This unique opportunity allows students and parents to interact directly with representatives from various countries, gaining valuable firsthand information about their study plans.",
        paragraph_two: "Moreover, we provide pre-departure support, equipping students with vital information about transportation systems, climates, time zones, laws, cultures, money matters, and other important aspects of their chosen study destination, ensuring a well-prepared transition.",
        image: image5,
    },    
    {
        id: 6,
        title: "Ongoing Support while studying",
        paragraph_one: "Our commitment to your success extends beyond your departure. Throughout your study journey, British AUC's Free Application Centre remains dedicated to providing continuous support and assistance.",
        paragraph_two: "We are here to help you navigate any challenges, ensuring a smooth integration into your chosen college or university community. We strive to ensure that you have all the necessary help and resources to thrive academically and personally.",
        image: image6,
    },
]